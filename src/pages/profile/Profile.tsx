                ...
                >
                    ...
                    >
                        <div style={{ marginTop: "10px" }}>
                            <b>Password Change</b>
                            <input name="old_pass" type="password" placeholder="OldPass" />
                            <br />
                            <input name="new_pass" type="password" placeholder="NewPass" />
                            <br />
                            <input
                                name="renew_pass"
                                type="password"
                        ...
                        <div>
                            ...
                            >
                                <p>
                                    Please click Resend Email to send a password change
                                    confirmation email
                                </p>
                                ...
                                //         Modal.success({
                                //             content: "Please confirm the password change email",
                                //         });

                ...
                <section >
                    <div className="container text-center text-md-start mt-5">
                        <div className="row mt-3">
                            ...
                            <div className="col-md-3 col-lg-4 col-xl-3 mx-auto mb-4">
                                <h6 className="text-uppercase fw-bold mb-4">ABOUT CAKERUN</h6>
                                <p>
                                    <a href="#!" className="text-reset">
                                        Corporate social
                                    </a>
                            ...
                            <div className="col-md-3 col-lg-4 col-xl-3 mx-auto mb-4">
                                <h6 className="text-uppercase fw-bold mb-4">PRIVACY CENTER</h6>
                                <p>
                                    <a href="#!" className="text-reset">
                                        Cookies Settings
                                    </a>
                            ...
                            <div className="col-md-3 col-lg-4 col-xl-3 mx-auto mb-4">
                                ...
                                <p>
                                    <i className="fas fa-home me-3" /> New York, NY 10012
                                </p>
                                <p>
